...
from llama_index.core.objects import SQLTableSchema, SQLTableNodeMapping, ObjectIndex, ObjectRetriever
...
class RetrieverManager:
    ...
    def setup_table_retriever(self) -> ObjectRetriever[SQLTableSchema]:
        # 确保目录存在
